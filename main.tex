...
%---------------------------RECOURS----------------------------------------+
\include{partials/07-presentation-projet-recours}
%-------------------------------------------------------------------+
\include{partials/08-conception-projet-recours}
%-------------------------------------------------------------------+
\include{partials/09-realisation-projet}
%-------------------------------------------------------------------+
\include{partials/10-bilan}
